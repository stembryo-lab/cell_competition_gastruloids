...
path_to_save_results = "/home/pablo/Desktop/papers/GastruloidCompetition_paper/cell_competition_gastruloids/image-analysis/results/p53_degron/spillover/"
...
ax.legend()
plt.tight_layout()
plt.savefig("{}spilloverA12.pdf".format(path_to_save_figures))
plt.show()
